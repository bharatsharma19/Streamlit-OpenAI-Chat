...
frequency_penalty = st.sidebar.slider("📉 Frequency Penalty", -2.0, 2.0, DEFAULT_FREQUENCY_PENALTY, 0.1)
presence_penalty = st.sidebar.slider("📈 Presence Penalty", -2.0, 2.0, DEFAULT_PRESENCE_PENALTY, 0.1)

# Main Chat Interface
st.title("🤖 ChatGPT - Custom UI")
st.markdown("Talk to OpenAI's ChatGPT with a fully configurable UI.")

user_message = st.text_area("🗨️ Your Message", placeholder="Type your question here...", height=100)
